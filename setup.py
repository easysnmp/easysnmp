...
def handle_vc():
	...
	vcpath = os.path.join(vcpath, "AppData", "Local", "Programs", "Common", "Microsoft", "Visual C++ for Python", "9.0", "vcvarsall.bat")
...
if platform.system() == 'Windows':
	...
	include_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "include")
	...
	'official Net-SNMP bindings - Fixed For Windows',
	author='Kent Coble',
	author_email='coblekent@gmail.com',
	url='https://github.com/kamakazikamikaze/easysnmp',
	license='BSD',
	py_modules=["easysnmp/compat", "easysnmp/easy", "easysnmp/exceptions", "easysnmp/helpers", "easysnmp/session", "easysnmp/utils", "easysnmp/variables"],
	packages=['easysnmp'],
	package_data={'easysnmp': ['netsnmp.dll', 'msvcr90.dll', "_socket.pyd"]},
	ext_modules=[
	du_Extension(
	'easysnmp.interface',
	...
	libraries=["python27", "Ws2_32", "netsnmp"],
